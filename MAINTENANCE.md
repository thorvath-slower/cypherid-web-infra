...
- **Add a stack** → new backend `key` (A4) and probably new remote-state blocks (A5). No register edit needed (covered by the glob), but follow [TERRAFORM.md §6](docs/TERRAFORM.md#add-a-new-component).
