...
#
# Sandbox is intentionally minimal. Defaults preserve the current sandbox sizing
# (no behavior change); they are surfaced as explicit variables so sizing is a
