...
provider "registry.terraform.io/hashicorp/aws" {
  version     = "5.100.0"
  constraints = ">= 3.72.0, >= 4.36.0, >= 4.45.0, >= 4.47.0, >= 4.57.0, >= 5.0.0, >= 5.99.0, ~> 5.100.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/helm" {
  version     = "2.17.0"
  constraints = "~> 2.0, >= 2.4.1, >= 2.9.0, >= 2.17.0, < 3.0.0, < 4.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/kubernetes" {
  version     = "3.1.0"
  constraints = ">= 2.10.0, >= 2.20.0, ~> 3.0, ~> 3.1.0"
  hashes = [
...
provider "registry.terraform.io/okta/okta" {
  ...
  constraints = "> 3.30.0"
  hashes = [
    "h1:6sRqEjmYJeOjUUqvYnDexjxPbBpZVUWm2UUG+mqAygw=",
